...
class AboutSymbols < Neo::Koan
  ...
  #
  # it may (depending on your ruby implementation) automatically be true, because asking about :test_method_names_become_symbols creates it.
  # https://stackoverflow.com/a/4686160/3354053
  ...
  # My answer: they stay in memory until the program exits. This makes them a memory hog if you misuse them.
  # https://stackoverflow.com/a/4574048/3354053
end
